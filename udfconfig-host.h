...
#define DOMAIN_ID(t)STRUCT_REF(t,3608,int)
#define PHASE_DOMAIN_INDEX(t)STRUCT_REF(t,3612,int)
#define DOMAIN_N_DOMAINS(t)STRUCT_REF(t,3620,int)
#define DOMAIN_SUPER_DOMAIN(t)STRUCT_REF(t,3808,Domain *)
#define DOMAIN_SUB_DOMAIN(t,i)(STRUCT_OFF(t,3632,Domain *)[i])

#define THREAD_STORE_START(t)(STRUCT_REF(t,1184,void *))
#define THREAD_STORAGE_START(t)(STRUCT_REF(t,1176,void *))
...
#define THREAD_DOMAIN(t)STRUCT_REF(t,1168,Domain *)
#define THREAD_HEAD(t)STRUCT_REF(t,0,Thread_Head *)
#define THREAD_MATERIAL(t)(STRUCT_REF(THREAD_HEAD(t),17032,Material *))
...
#define P_VF(p)STRUCT_REF(p,2816,real)
#define P_CF(p)STRUCT_REF(p,2824,real)
#define P_VFF(p)STRUCT_REF(p,2832,real)
#define P_DF(p)STRUCT_REF(p,2840,real)
...
#define P_EVAP_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),7336,int)
#define P_DEVOL_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),7340,int)
#define P_OXID_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),7344,int)
#define P_PROD_SPECIES_INDEX(p)STRUCT_REF(P_INJECTION(p),7348,int)
#define P_LAWS(p,in)STRUCT_OFF(P_INJECTION(p),900,int)[in]
